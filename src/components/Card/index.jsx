...
export default function FormCard({ formName, formDescription, id, onDelete, onArchive, offArchive, handleSend, Template, handleRestore, Trash, buitInTemplate, TemplateForm }) {
